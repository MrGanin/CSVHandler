...
def create_csv(filename, data):
    with open(filename, 'w', newline='', encoding='utf-8') as f:
        writer = csv.writer(f)
        writer.writerow(['title', 'ctr', 'retention_rate', 'views', 'likes', 'avg_watch_time'])
        writer.writerows(data)

create_csv('stats1.csv', data1)
create_csv('stats2.csv', data2)
print("✅ Тестовые файлы созданы: stats1.csv, stats2.csv")